...
<div class="col-md-6 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        <h4 class="card-title">Add Researve Currency</h4>

        <form class="forms-sample" action="{{ route('store.researve.currencies')}}" method="POST" >
            @csrf
        ...
        @endphp
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="exampleInputUsername1" placeholder="800.94" name="amount">
          </div>
